...
$config['endpoint'] = array(
    array(
        ...
        // 'base_uri' => 'http://45.198.8.110/posonet/billing_api/', // Base URL for your API endpoints
    ...
    array(
        ...
        // 'base_uri' => 'http://45.198.8.110/primahome/billing_api/', // Base URL for your API endpoints
        'token' => 'POSONET-EP-SW5pS29kZVJhaGFzaWE=', // Client key for authentication
    ),
);
...
$config['csrf_token_name'] = 'csrf_posonetmidtrans-Il0028836281336Ygst';
$config['csrf_cookie_name'] = 'csrf_cookie_Knjasd0YhKksBUWM9uo';
$config['csrf_expire'] = 7200;
$config['csrf_regenerate'] = TRUE;
$config['csrf_exclude_uris'] = array("notification");
