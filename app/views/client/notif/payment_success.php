    ...
    <div class="container">
            ...
            <div class="watermark-pattern">
                ...
                for ($y = -$gapY; $y < $containerHeight + $gapY; $y += $gapY) {
                    for ($x = -$gapX; $x < $containerWidth + $gapX; $x += $gapX) {
                        echo '<div class="watermark-text" style="left: '.$x.'px; top: '.$y.'px;">POSONET</div>';
                    }
                }
                ?>
                </div>
        ...
        <div class="details">
            ...
            <div style="flex:1 1 45%; min-width: 140px;">
                ...
                <div style="font-weight:600; color:#111827;"><?=$payment_type?></div>
            </div>
            <div style="flex:1 1 45%; min-width: 140px;">
        ...
        <div style="display: flex; gap: 12px; justify-content: center; margin-bottom: 8px;">
            <a href="/posonet-midtrans/" id="dash-proof" class="btn btn-outline" style="flex:1;">Kembali</a>
            <button id="save-proof" class="btn" style="flex:1; margin-top:0;">Simpan</button>
        </div>
        <div style="text-align: center; font-size: 0.9rem; color: #6B7280; margin-top: 16px;">
            <small>Jika ada pertanyaan, silakan hubungi kami di <a href="https://wa.me/6285298470228" style="color: #036ffc;">WhatsApp</a>.</small>
        </div>
