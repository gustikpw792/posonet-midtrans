    ...
    <div class="middle-box xcol-md-12 loginscreen">
        <div class="ibox-content">
            ...
            <form class="m-t" role="form" action="<?=site_url('getInvoice')?>" method="POST">
                ...
                <!-- <br><br>
                <div class="g-recaptcha" data-sitekey="6LeFN-orAAAAAGChj_iDVPxYcOBQ6isURmRaRWVK"></div>
                <br><br> -->

                <button type="submit" class="btn btn-outline btn-primary btn-lg block full-width m-b">CEK TAGIHAN</button>
            </form>
